...
```bash
npx --yes --package @okf-harness/cli@0.8.1 okfh init <workspace> --name <name> --agents claude --dry-run --json
npx --yes --package @okf-harness/cli@0.8.1 okfh init <workspace> --name <name> --agents claude --json
