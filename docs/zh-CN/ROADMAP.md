...
它与完整桌面 LLM Wiki 应用的核心区别是有意为之：OKF Harness 不试图成为主要的知识库应用。你继续在 Claude Code、Codex 和未来的 agent 客户端中工作；harness 在普通 markdown 文件之上提供透明的本地 workspace、确定性 CLI、受控证据、受控读取、lint 和图谱报告。
